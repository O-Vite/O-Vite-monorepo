// import { ArticleDb } from '../../services/database/entities/article.entity';
...
// export type ArticleDto = Omit<ArticleDb, 'confidential' | 'content'>;
// export type ArticleCreateDto = TOmitBaseEntity<ArticleDb>;
